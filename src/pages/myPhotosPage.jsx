...
//                         imagen && ( // Verificación adicional para asegurarse de que imagen no es nulo
//                             <ImgComponent
//                                 key={imagen.id}
//                                 id={imagen.id}
//                                 image={imagen.image}
...
// import { InputSearchDescriptionComponent } from '../components/inputComponent/inputComponent';
// import { ModalComponent } from "../components/modalComponent/modalComponent";
// import { removeFavorite } from '../../features/myPhotos/myPhotoSlice';
...
//         setImagenesFiltradas(imagenesFiltradas.filter(imagen => imagen.id !== id));
//     };
...
//                                 buttonSearch={false}
//                                 onClick={() => handleImageClick(imagen)}
//                                 onRemove={() => handleRemoveFavorite(imagen.id)} // Aquí se pasa la función
//                             />
//                         )
//                     ))
//                 ) : (
...
//                                 buttonSearch={false}
//                                 onClick={() => handleImageClick(imagen)}
//                                 onRemove={() => handleRemoveFavorite(imagen.id)} // Asegúrate de pasar onRemove
//                             />
//                         )
//                     ))
//                 ) : (
